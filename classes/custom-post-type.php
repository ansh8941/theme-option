...

            {
...

                {
...

                    {
                        ...
                        if(!empty($meta[$field_id_name][0]) ){$meta_field_value = $meta[$field_id_name][0];}else{$meta_field_value ='';}

                         echo '<div class="cpt_field"><label for="' . $field_id_name . '">' . $label . '</label><input type="text" name="custom_meta[' . $field_id_name . ']" id="' . $field_id_name . '" value="'.$meta_field_value.'" /></div>';
...

    {
        ...
        add_action( 'save_post',
...

            {
                ...
                if( !empty($_POST) && isset( $post->ID ) && get_post_type( $post->ID ) == $post_type_name )
